...
// la forma en que te moverás entre diferentes elementos se le 
// conoce como Traversing the DOM, ir recorriendolo..


const navegacion = document.querySelector('.navegacion');
console.log(navegacion);

// Cada elemento en la navegación los diferentes elementos se 
// les conoce como Nodos... y podrás listarlos de la siguiente forma...
// console.log(navegacion.childNodes);
// también existe algo llamado Children
console.log(navegacion.children[0])

// // La diferencia es que childNodes te va a mostrar hasta los espacios en 
// // blanco, children te muestra solo los elementos...
...
// en javascript puedes seleccionar un elemento y navegar en sus diferentes 
// elementos... por ejemplo el card...
...
// Si quieres accedera  los elementos hijos de ese info... 
// recuerda puedes anidar las propiedades.
...
// Intenta cambiar el texto que dice concierto por algo más 
// siguiendo esta sintaxis de ir navegando por el DOM...
...
// En el script anterior vimos como hacer traversing de un elemento 
// padre hacia el hijo, JavaScript también te permite seleccionar un 
// elemento hijo e ir navegando hacia el padre...
...
// En JavaScript también es posible de hacer traversing a elementos 
// que estan en el mismo nivel , digamos el vecino aunque en javascript se les conoce como hermanos...
