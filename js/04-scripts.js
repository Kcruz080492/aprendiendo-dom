...
// solo va a retornar el primero...

const card = document.querySelector('.card'); // QuerySelctor utiliza una sintaxis como 
// de selector de CSS, por lo tanto si deseas seleccionar una clase, debe tener un punto al inicio...
...
const formulario = document.querySelector('#formulario'); // En CSS seleccionas 
// los ID con un signo de numeral..
console.log(formulario);
// También los ID pueden tener selectores especificos como el de arriba, pero 
// recuerda un ID es único asi que no tendría mucho sentido no?
